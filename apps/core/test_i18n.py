...
class TestInternationalization:
    ...
    def test_translation_activation(self):
        ...
        assert _("Bem-vindo ao Personal Trainer App") == "Bem-vindo ao Personal Trainer App"
        
        # Ativar inglês
        translation.activate('en')
        from django.utils.translation import gettext as _
        assert _("Bem-vindo ao Personal Trainer App") == "Welcome to Personal Trainer App"
        
        # Ativar espanhol
        translation.activate('es')
        from django.utils.translation import gettext as _
        assert _("Bem-vindo ao Personal Trainer App") == "Bienvenido a la App Entrenador Personal"
